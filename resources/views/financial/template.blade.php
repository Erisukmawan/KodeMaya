...
@section('header-element')
    <div class="flex justify-between items-center h-full">
        <div class="flex items-center md:space-x-4 space-x-2 xl:space-x-0 rtl:space-x-reverse vertical-box">
            <a href="{{ route('financial.menu.dashboard') }}" class="mobile-logo xl:hidden inline-block">
        ...
        <div class="main-menu">
            <ul>
                <li class="{{ request()->is('financial/dashboard') ? 'active' : '' }} menuatas">
        ...
        <div class="nav-tools flex items-center lg:space-x-5 space-x-3 rtl:space-x-reverse leading-0">
            ...
            <div class=" w-full">
                <button
                    ...
                    <span
                        class="flex-none text-slate-600 dark:text-white text-sm font-normal items-center lg:flex hidden overflow-hidden text-ellipsis whitespace-nowrap">{{ Auth::guard('webfinance')->user()->nama }}</span>
...
@section('menu-mobile')
    <div
        ...
        <a href="{{ route('financial.menu.review') }}">
            <div class="{{ request()->is('financial/review*') ? 'active' : '' }} menubawah">
                <span
                    class="textcol relative cursor-pointer rounded-full text-[20px] flex flex-col items-center justify-center mb-1 dark:text-white
          text-slate-900 ">
