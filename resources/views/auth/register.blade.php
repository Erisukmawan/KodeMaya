...
@section('content-form')
    <form class="space-y-4" action="{{ route('register_customer_process') }}" method="post">
        ...
        <button id="buatakun" class="mt-8 btn btn-secondary w-full text-center" style="cursor:no-drop" disabled>Buat
            Akun</button>
        <button id="buatakunload" class="mt-8 btn hidden justify-center w-full text-center btn-success"
