        ...
        <div id="content_layout">
            <div class="flex md:space-x-5 app_height overflow-hidden relative rtl:space-x-reverse">
                ...
                <div class="flex-1 md:w-[calc(100%-320px)]">
                    <div class="h-full card">
                        <div class="p-0  h-full relative card-body">
                            ...
                            <!-- BEGIN: Email Header -->
                            <div
                                class="md:flex justify-between items-center sticky bg-white dark:bg-slate-800 top-0 pt-6 pb-4 px-6 z-[3] border-b border-slate-100 dark:border-slate-700 rounded-t-md">
                                <div class="flex items-center rtl:space-x-reverse">
                                    <div
                                        class="open-sidebar md:h-8 md:w-8 h-6 w-6 bg-slate-100 dark:bg-slate-900 dark:text-slate-400 flex flex-col justify-center items-center ltr:mr-3 rlt:ml-3 lg:hidden md:text-base text-sm rounded-full cursor-pointer">
                                    ...
                                    <div class="max-w-[180px] flex items-center space-x-1 rtl:space-x-reverse leading-[0]">
                                        ...
                                        <div>
                                            <input type="text" id="email-search" placeholder="Search Email"
                    ...
                    focus:outline-none">
                                    ...
                                    <div class="relative">
                                        <div class="dropdown relative">
                                            <button class="text-xl text-center block w-full " type="button"
                                                id="emailDropdownMenuButton" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                                <iconify-icon icon="heroicons-outline:dots-vertical"></iconify-icon>
                                            </button>
                                            <ul
                                                class=" dropdown-menu min-w-[160px] absolute text-sm text-slate-700 dark:text-white hidden bg-white dark:bg-slate-700 shadow z-[2] float-left overflow-hidden list-none text-left rounded-lg mt-1 m-0 bg-clip-padding border-none">
                                                <li>
                                                    <a href="./#"
                            ...
                            space-x-2 rtl:space-x-reverse inline-flex items-center dark:hover:text-white">
                                                        <span class=" text-lg leading-[0]">
                                                            <iconify-icon icon="heroicons-outline:sort-ascending">
                                                            </iconify-icon>
                                                        </span>
                            ...
                            space-x-2 rtl:space-x-reverse inline-flex items-center dark:hover:text-white">
                                                        <span class=" text-lg leading-[0]">
                                                            <iconify-icon icon="heroicons-outline:sort-descending">
                                                            </iconify-icon>
                                                        </span>
                                                        <span>Sort Z-A
                                                        </span>
                                    ...
                                    <li data-status="sent,spam,personal,business" data-stared="false"
                                        ...
                                        <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                            <div class="flex-none">
                                                <div class="h-8 w-8 rounded-full text-white">
                                                    <img src="assets/images/avatar/av-1.svg" alt=""
                                        ...
                                        <p class="truncate">
                                            ...
                                            <span class="text-sm text-slate-600 dark:text-slate-300 font-normal">
                                                - Congratulations on your iRun Coach subscription. You made no space for
                                                excuses and
                                                you decided on a healthier and happier life...
                                            </span>
                                        </p>
                                        <div class="grow"></div>
                                        <span>
                                            ...
                                            <span
                                                class="absolute ltr:right-0 rtl:left-0 top-1/2 -translate-y-1/2 dark:text-slate-300 group-hover:bg-slate-100
                ...
                delete-button group-hover:opacity-100 group-hover:visible">
                                    ...
                                    <li data-status="drafts,business,promotions,stared" data-stared="true"
                                        class="flex px-7 space-x-6 group md:py-6 py-3 relative cursor-pointer hover:bg-slate-50 dark:hover:bg-transparent group
                                                                                                                                                                            items-center rtl:space-x-reverse">
                                        <div>
                                            <input type="checkbox" class="table-checkbox" name="email-checkbox">
                                        ...
                                        <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                            <div class="flex-none">
                                                <div class="h-8 w-8 rounded-full text-white">
                                                    <img src="assets/images/avatar/av-2.svg" alt=""
                                                        class="block w-full h-full object-cover">
                                                </div>
                                            </div>
                                            <div class="read-unread-name flex-1 text-sm min-w-max">
                ...
                delete-button group-hover:opacity-100 group-hover:visible">
                                    ...
                                    <li data-status="stared,promotions,social" data-stared="true"
                                        class="flex px-7 space-x-6 group md:py-6 py-3 relative cursor-pointer hover:bg-slate-50 dark:hover:bg-transparent group
                                                                                                                                                                            items-center rtl:space-x-reverse">
                                        <div>
                                            <input type="checkbox" class="table-checkbox" name="email-checkbox">
                                        ...
                                        <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                            <div class="flex-none">
                                                <div class="h-8 w-8 rounded-full text-white">
                                                    <img src="assets/images/avatar/av-3.svg" alt=""
                                                        class="block w-full h-full object-cover">
                                                </div>
                                            </div>
                                            <div class="read-unread-name flex-1 text-sm min-w-max">
                ...
                delete-button group-hover:opacity-100 group-hover:visible">
                                    ...
                                    <li data-status="spam,social,stared" data-stared="true"
                                        class="flex px-7 space-x-6 group md:py-6 py-3 relative cursor-pointer hover:bg-slate-50 dark:hover:bg-transparent group
                                                                                                                                                                            items-center rtl:space-x-reverse">
                                        <div>
                                            <input type="checkbox" class="table-checkbox" name="email-checkbox">
                                        ...
                                        <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                            <div class="flex-none">
                                                <div class="h-8 w-8 rounded-full text-white">
                                                    <img src="assets/images/avatar/av-4.svg" alt=""
                                                        class="block w-full h-full object-cover">
                                                </div>
                                            </div>
                                            <div class="read-unread-name flex-1 text-sm min-w-max">
                            ...
                            <div class="absolute left-0 top-0 w-full h-full bg-white dark:bg-slate-800 z-[55] rounded-md p-6 overflow-y-auto"
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-slate-600 dark:text-slate-300 font-normal">
                                        Hi Jane Cooper, <br /> <br /> Jornalists call this critical, introductory section
                                        the
                                        "Lede," and when bridge properly
                                        executed, it's the that carries your reader from an headine try at
                                        attention-grabbing to
                                        the body of your blog post, if
                                        you want to get it right on of these 10 clever ways to omen your next blog
                                        <br /> <br /> posr with a bang With resrpect, i must disagree with Mr.Zinsser. We
                                        all know
                                        the most part of important part
                                        of any article is the title.Without a compelleing title, your reader won't even get
                                        to the
                                        first sentence.After the
                                        title, however, the first few sentences of your article are certainly the most
                                        important
                                        part.
                                        <br /> <br /> Best regards,
                                        <br /> Esther Howard
                                    ...
                                    <div
                                        ...
                                        <div class="text-center">
                                            <div class="h-[95px] w-[150px] rounded">
                                                <img src="assets/images/all-img/inbox-1.png" alt=""
                                                    class="block w-full h-full object-cover">
                                            </div>
                                        ...
                                        <div class="text-center">
                                            <div class="h-[95px] w-[150px] rounded">
                                                <img src="assets/images/all-img/inbox-2.png" alt=""
                                                    class="block w-full h-full object-cover">
                                            </div>
                                            <button class="text-sm text-primary-500 mt-2" type="button">
                                                Download
                                        ...
                                        <div class="text-center">
                                            <div class="h-[95px] w-[150px] rounded">
                                                <img src="assets/images/all-img/inbox-3.png" alt=""
                                                    class="block w-full h-full object-cover">
                                            </div>
                                            <button class="text-sm text-primary-500 mt-2" type="button">
                                                Download
                                    ...
                                    <div>
                                        <button
                                            class="btn bg-slate-100 text-slate-900 dark:text-slate-300 hover:bg-slate-300 dark:bg-slate-900 btn-sm ">
                                            Reply
                                        </button>
                                    </div>
                                </div>
