...
@section('sidebar')
    <div class="sidebar-wrapper group">
        ...
        <div id="nav_shadow"
            class="nav_shadow h-[60px] absolute top-[80px] nav-shadow z-[1] w-full transition-all duration-200 pointer-events-non opacity-0">
        </div>
        <div class="sidebar-menus bg-white dark:bg-slate-800 py-2 px-4 h-[calc(100%-80px)] overflow-y-auto z-50"
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a class="{{ request()->is('admin/tulung/post*') ? 'active' : '' }}"
                                href="{{ route('admin.features.tulung.post') }}">Profil Unggahan</a>
                        </li>
                        <li>
                            <a class="{{ request()->is('admin/tulung/task*') ? 'active' : '' }}"
                                href="{{ route('admin.features.tulung.task') }}">Status Pengerjaan</a>
                        </li>
                        <li>
                            <a class="{{ request()->is('admin/tulung/history*') ? 'active' : '' }}"
                                href="{{ route('admin.features.tulung.history') }}">Riwayat</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a href="javascript:void(0)" class="navItem">
                        <span class="flex items-center">
                            <iconify-icon class="nav-icon" icon="heroicons-outline:pencil-square"></iconify-icon>
                            <span>Parameter</span>
                        </span>
                        <iconify-icon class="icon-arrow" icon="heroicons-outline:chevron-right"></iconify-icon>
                    </a>
                    <ul class="sidebar-submenu">
                        <li>
                            <a class="{{ request()->is('admin/global*') ? 'active' : '' }}"
                                href="{{ route('admin.menu.parameter.global') }}">Global</a>
                        </li>
                        <li>
                            <a class="{{ request()->is('admin/enum*') ? 'active' : '' }}"
                                href="{{ route('admin.menu.parameter.enum') }}">Enum</a>
                        </li>
                    </ul>
                </li>
                ...
                <!-- Feature Area -->
                <li class="sidebar-menu-title">UTILITAS</li>
                <li class="{{ request()->is('admin/file-manager*') ? 'active' : '' }}">
                    <a href="{{ route('admin.utility.file-manager') }}" class="navItem">
                        <span class="flex items-center">
                            <iconify-icon class=" nav-icon" icon="uil:transaction"></iconify-icon>
            ...
            <div class="bg-slate-900 mb-10 mt-10 p-2 relative text-center rounded-3xl text-white"
                id="sidebar_bottom_wizard">
                <div>
                    <a href="{{ url('/service-logs') }}" target="_blank"
                        class="text-slate-900 text-xs text-white font-Inter rounded-md w-full block py-2 font-medium">
                        System Logs
                    </a>
                </div>
            </div>
