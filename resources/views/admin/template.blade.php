            ...
            <div class=" w-full">
                <button
                    ...
                    <div class="lg:h-8 lg:w-8 h-7 w-7 rounded-full flex-1 ltr:mr-[10px] rtl:ml-[10px]">
                        <img src="{{ Auth::guard('webadministration')->user()->foto_profil ? Auth::guard('webadministration')->user()->foto_profil : url('assets/images/avatar/av-1.svg') }}"
                            alt="user" class="block w-full h-full object-cover rounded-full">
                    </div>
                    <span
                        class="flex-none text-slate-600 dark:text-white text-sm font-normal items-center lg:flex hidden overflow-hidden text-ellipsis whitespace-nowrap">{{ Auth::guard('webadministration')->user()->nama }}</span>
