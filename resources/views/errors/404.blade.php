  ...
  <div class="min-h-screen">
    ...
    <div class="container">
      <div class="flex justify-center flex-wrap items-center min-h-screen flex-col text-center">
        <img src="{{url('assets/images/all-img/404.svg')}}" alt="">
        <h4 class="text-3xl font-medium text-slate-900 dark:text-white mb-2">
          Woopsie Error 404.
        </h4>
        <p class="font-normal mb-4 text-base text-slate-500 dark:text-slate-300">
          Maaf Halaman yang anda cari tidak ditemukan.
        </p>
        <button onclick="history.go(-1)"
                            class="w-2/4 rounded-full px-4 py-2 hover:bg-slate-500 dark:hover:bg-info-600 bg-slate-600 dark:hover:text-white font-inter text-sm text-white dark:text-white font-normal">
