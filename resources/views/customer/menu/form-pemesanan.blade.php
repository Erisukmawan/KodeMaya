...
@section('main-content')
    <div class="card xl:col-span-2 rounded-md bg-white dark:bg-slate-800 lg:h-full shadow-base">
        <div class="card-body flex flex-col p-6">
            <form action="{{ route('customer.menu.pemesanan.create') }}" method="post">
                @csrf
                <header
                    ...
                    <div class="input-area">
                        ...
                        <div class="relative">
                            <input id="nama_projek" name="nama_projek" type="text" class="form-control"
                                placeholder="Apa Nama projek Anda ?" required>
                ...
                <div class="card-text h-full space-y-8 mb-3">
                    <div class="input-area">
                        ...
                        <div class="relative">
                            <select name="kategori" id="kategori" class="form-control w-full mt-2" required>
                                ...
                                <option value="MOBILE"
                                    class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">
                                    MOBILE</option>
                                <option value="DS/ML/AI"
                                    class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">DS/ML/AI
                                </option>
                                <option value="UI/UX"
                                    class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">
                                    UI/UX</option>
                ...
                <div
                    ...
                    <div class="flex items-start space-x-3 rtl:space-x-reverse">
                        <div class="flex-1 text-left">
                            Harga Awal Akan Ditampilkan ketika anda memilih Kategori, harga bisa anda tentukan sendiri tapi
                            harus diatas harga awal, anda bisa negosiasi harga dengan mentor nantinya
                        </div>
                    </div>
                </div>
                <div class="card-text h-full space-y-8 mb-3">
                    <div class="input-area">
                        ...
                        <div class="relative">
                            <input id="harga" name="harga" type="tel" min="" class="form-control !pl-9"
                                placeholder="harga" required>
                            <span class="absolute left-2 top-1/2 -translate-y-1/2 text-base text-slate-500">Rp</span>
                        </div>
                        <span id="harga-error" class="error" style="display: none;">Angka tidak boleh kurang dari harga
                            yang
                ...
                <div class="card-text h-full space-y-8 mb-3">
                    <div class="input-area">
                        ...
                        <div class="relative">
                            ...
                            <textarea id="DrowsTextarea" name="deskripsi_projek" class="form-control" rows="5" placeholder="Text Area"></textarea>
                ...
                <button type="submit" class="flex w-full items-center justify-center btn-success bg-white btn-sm btn">
