      ...
      <div class="bg-no-repeat bg-cover bg-center px-5 py-8 rounded-xl relative flex items-center" style="background-image: url({{url('assets/images/all-img/widget-bg-7.png')}})">
                  ...
                  <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
                    <div class="card">
                      ...
                      <div class="flex-none">
                                <span class="block font-normal w-full rounded-2xl bg-success-500 text-white dark:text-slate-800 text-sm p-1">SELESAI</span>
                              </div>
                          </header>
                      <div class="card-body p-6">
                        <div class="space-y-6">
                          ...
                          <a href="{{route('customer.menu.pemesanan.detail_pemesanan')}}" class="inline-flex items-center space-x-3 rtl:space-x-reverse text-sm capitalize font-medium text-slate-600
                                dark:text-slate-300">
                    ...
                    <div class="card">
                      ...
                      <div class="flex-none">
                                <span class="block font-normal w-full rounded-2xl bg-warning-500 text-white dark:text-slate-800 text-sm p-1">SEDANG DIPROSES</span>
                              </div>
                          </header>
                      <div class="card-body p-6">
                        <div class="space-y-6">
                    ...
                    <div class="card">
                      ...
                      <div class="flex-none">
                                <span class="block font-normal w-full rounded-2xl bg-info-600 text-white dark:text-slate-800 text-sm p-1">MENUNGGU</span>
                              </div>
                          </header>
                      <div class="card-body p-6">
                        <div class="space-y-6">
