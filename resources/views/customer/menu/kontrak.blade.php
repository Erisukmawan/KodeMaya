...
<div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
                    <div class="card">
                      ...
                      <div class="flex-none">
                                <span class="block font-normal w-full rounded-2xl bg-danger-500 text-white dark:text-slate-800 text-sm p-1">BELUM DISETUJUI</span>
                              </div>
                          </header>
                      <div class="card-body p-6">
                        <div class="space-y-6">
                          ...
                          <a href="{{route('customer.menu.kontrak.detail_kontrak')}}" class="inline-flex items-center space-x-3 rtl:space-x-reverse text-sm capitalize font-medium text-slate-600
                                dark:text-slate-300">
                                ...
                                <tr>
                                  ...
                                  <td class="table-td ">
                                      <div class="flex space-x-2">
                                        <a href="{{route('customer.menu.kontrak.detail_kontrak')}}">
