...
<section class="Fitur" id="Mentor" data-aos="fade-up">
    <div class=" space-y-5">
        ...
        <div class="card-body p-6">
            <div class="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5">
                <div data-aos="zoom-out-up" data-aos-duration="1500" class="price-table bg-opacity-[0.16] dark:bg-opacity-[0.36] rounded-[6px] p-6 text-slate-900 dark:text-white relative overflow-hidden z-[1] bg-warning-500">
                ...
                <div class="price-table bg-opacity-[0.16] dark:bg-opacity-[0.36] rounded-[6px] p-6 text-slate-900 dark:text-white relative overflow-hidden z-[1] bg-info-500" data-aos="zoom-out-up" data-aos-duration="1500">
                    <div class="overlay absolute right-0 top-0 w-full h-full z-[-1]">
    ...
    rtl:-left-[43px] top-6 px-10 transform ltr:rotate-[45deg] rtl:-rotate-45">
                ...
                <div class="price-table bg-opacity-[0.16] dark:bg-opacity-[0.36] rounded-[6px] p-6 text-slate-900 dark:text-white relative overflow-hidden z-[1] bg-success-500" data-aos="zoom-out-up" data-aos-duration="1500">
                    <div class="overlay absolute right-0 top-0 w-full h-full z-[-1]">
