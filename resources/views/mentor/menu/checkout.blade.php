            ...
            <div class="card-text h-full space-y-4">
                <div class="primary-radio">
                    <label class="flex items-center cursor-pointer ">
                        ...
                        <span
                            class="text-slate-900 w-full font-Inter font-normal text-base leading-6 capitalize dark:text-slate-300">BNI
                ...
                <div class="primary-radio">
                    <label class="flex items-center cursor-pointer ">
                        <img src="{{ url('/assets/images/logo/visa.svg') }}" alt="user"
                            class="block w-20 h-auto object-cover pr-3 border hover:border-white border-transparent">
                        <span
                            class="text-slate-900 w-full font-Inter font-normal text-base leading-6 capitalize dark:text-slate-300">Visa
                            Virtual Account</span>
                ...
                <div class="primary-radio">
                    <label class="flex items-center cursor-pointer  ">
                        <img src="{{ url('/assets/images/logo/qris.png') }}" alt="user"
                            class="block w-20 h-auto object-cover pr-3 border hover:border-white border-transparent">
                        <span
                            class="text-slate-900 w-full font-Inter font-normal text-base leading-6 capitalize dark:text-slate-300">QRIS
                            Code</span>
                        <input type="radio" class="hidden" name="arrayRadio[]" value="QRIS">
                        <span
                            class="flex-none bg-white dark:bg-slate-500 rounded-full border inline-flex  relative transition-all duration-150 h-[16px] w-[16px] border-slate-400 dark:border-slate-600 dark:ring-slate-700"></span>
                    </label>
                </div>
            </div>
        </div>
            ...
            <div class="card-text h-full text-center mt-4">
                <div class="grid lg:grid-cols-3 space-y-1 md:grid-cols-3 grid-cols-1 gap-4">
                    ...
                    <div class="input-area">
                        ...
                        <div class="relative">
                            <span
                                class="text-base font-Inter font-bold dark:text-slate-200 text-slate-900 mt-2 inline-block">{{ Auth::guard('webmentor')->user()->nama }}</span>
                        </div>
                    </div>
                    <div class="input-area">
