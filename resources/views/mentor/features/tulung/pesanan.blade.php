...
@section('main-content')
                    ...
                    <div class="h-full card">
                      <div class="card-body relative p-0 h-full overflow-hidden">
                        ...
                        <div class=" dark:border-slate-700 py-1">
                          ...
                          <span class="block text-slate-800 dark:text-slate-300 text-sm font-medium mb-[2px]" style="text-align: center;">
                              Riwayat Pesan
                          </span>
                        </div>
                        <!-- end seach -->
                              ...
                              <div class="flex space-x-3 px-6 rtl:space-x-reverse">
                                <div class="flex-none">
                                  <div class="h-10 w-10 rounded-full relative">
                                    ...
                                    <img src="{{ url('assets/images/users/user-2.jpg')}}" alt="" class="block w-full h-full object-cover rounded-full">
                                  </div>
                                </div>
            ...
            dark:hover:bg-slate-600 dark:hover:bg-opacity-70">
                        ...
                        bg-success-500 "></span>
                                    <img src="{{ url('assets/images/users/user-5.jpg')}}" alt="" class="block w-full h-full object-cover rounded-full">
                                  </div>
                                </div>
                                <div class="flex-1 text-start flex">
                                  <div class="flex-1">
            ...
            dark:hover:bg-slate-600 dark:hover:bg-opacity-70">
                              <div class="flex space-x-3 px-6 rtl:space-x-reverse">
                                <div class="flex-none">
                                  <div class="h-10 w-10 rounded-full relative">
                                    <span class=" status ring-1 ring-white inline-block h-[10px] w-[10px] rounded-full absolute -right-0 top-0  bg-secondary-500 "></span>
                                    <img src="{{ url('assets/images/users/user-1.jpg')}}" alt="" class="block w-full h-full object-cover rounded-full">
                                  </div>
                                </div>
                                <div class="flex-1 text-start flex">
                                  <div class="flex-1">
                                  ...
                                  <div class="block md:px-6 px-4">
                                    <div class="flex space-x-2 items-start group rtl:space-x-reverse">
                                      ...
                                      <div class="flex-1 flex space-x-4 rtl:space-x-reverse">
                                        <div>
                                          <div class="text-contrent p-3 bg-slate-100 dark:bg-slate-600 dark:text-slate-300 text-slate-600 text-sm font-normal mb-1 rounded-md flex-1 whitespace-pre-wrap break-all">Hey! How are you?</div>
                                        ...
                                        <div class="break-all">
                                          <div class="text-contrent p-3 bg-slate-300 dark:bg-slate-900 dark:text-slate-300 text-slate-800 text-sm font-normal rounded-md flex-1 mb-1">
                                            <video class="w-full" id="player" playsinline="playsinline"
                                                controls="controls" data-poster="https://vjs.zencdn.net/v/oceans.png">
                                      ...
                                      <div class="no flex space-x-4 rtl:space-x-reverse">
                                        ...
                                        <div class="break-all">
                                          <div class="text-contrent p-3 bg-slate-300 dark:bg-slate-900 dark:text-slate-300 text-slate-800 text-sm font-normal rounded-md flex-1 mb-1">
                                            ...
                                            <br><hr><div class="flex-none" style="text-align: center;">
                                                <a href="https://www.freecodecamp.org/news/content/images/size/w2000/2022/09/jonatan-pie-3l3RwQdHRHg-unsplash.jpg" Download="ags" ><button type="button"  class="text-xs text-slate-900 dark:text-white">
                                                   Download
                                                </button>
                                            </div>
                                          </div>
                                            ...
                                            <li class="block py-[8px]">
                                                <div class="flex space-x-2 rtl:space-x-reverse">
                                                    <div class="flex-1 flex space-x-2 rtl:space-x-reverse">
                                                        <div class="flex-none">
                                                            <div class="h-8 w-8">
                                                                <img src="{{ url('assets/images/icon/pdf-1.svg')}}" alt=""
                                                        ...
                                                        <div class="flex-1">
                                                            ...
                                                            <span class="block font-normal text-xs text-slate-500 mt-1">155MB
                                                            </span>
                                                            <button type="button"
            ...
            dark:border-slate-700">
                    ...
                    items-center text-xl rounded-full" id="konten"><iconify-icon icon="heroicons-outline:link">
                    </iconify-icon>
                          ...
                          <div class="p-0 h-full card-body">
                            ...
                            <div data-simplebar class="h-full p-6">
                              ...
                              <ul class="grid grid-cols-3 gap-2">
                                <li class="h-[46px]">
                                  <img src="{{ url('assets/images/chat/sd1.png')}}" alt="" class="w-full h-full object-cover rounded-[3px]">
                                </li>
                                <li class="h-[46px]">
                                  <img src="{{ url('assets/images/chat/sd2.png')}}" alt="" class="w-full h-full object-cover rounded-[3px]">
                                </li>
                                <li class="h-[46px]">
                                  <img src="{{ url('assets/images/chat/sd3.png')}}" alt="" class="w-full h-full object-cover rounded-[3px]">
                                </li>
                                <li class="h-[46px]">
                                  <img src="{{ url('assets/images/chat/sd4.png')}}" alt="" class="w-full h-full object-cover rounded-[3px]">
                                </li>
                                <li class="h-[46px]">
                                  <img src="{{ url('assets/images/chat/sd5.png')}}" alt="" class="w-full h-full object-cover rounded-[3px]">
                                </li>
                                <li class="h-[46px]">
                                  <img src="{{ url('assets/images/chat/sd6.png')}}" alt="" class="w-full h-full object-cover rounded-[3px]">
                                </li>
                              </ul>
                            </div>
                            <!-- END: Info Area -->
