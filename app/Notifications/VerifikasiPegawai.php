...
class VerifikasiPegawai extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $payload = [
            'id_pegawai' => $notifiable->id_pegawai,
        ...
        return (new MailMessage)
                    ...
                    ->action('Verifikasi', url('/verify-account?&token='.$jwt_token.'&state=0&acc_type=employee'))
